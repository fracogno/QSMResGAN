    ...
    while True:
        try:
            ...
            if globalStep % 250 == 0:
                ...
                summary = sess.run(val_merged_summaries, feed_dict={ rmseTensor: metrics[0], ddrmseTensor: metrics[1],
                                                                     ddrmseTissueTensor: metrics[2], ddrmseBloodTensor: metrics[3],
                                                                     ddrmseDGMTensor: metrics[4], deviationFromLinearSlopeTensor: metrics[5],
                                                                     calcStreakTensor: metrics[6], deviationFromCalcMomentTensor: metrics[7] })
