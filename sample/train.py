...
def train(params):
    ...
    kernels_shape = {key: dataset[key][0]["x"].shape[1:4] if "qsm" in key else params["crop_shape"] for key in dataset}"""
    ...
    while True:
        ...
        for mode in slv.modes:
            slv.iterate_dataset(vn, dataset[mode], epoch, mode)
...
if __name__ == "__main__":
    ...
    optimizer_vector = [tf.keras.optimizers.RMSprop]  # Adam, Adamax, Nadam, Ftrl, RMSprop
