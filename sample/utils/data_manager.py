...
def get_QSM_datasets(base_path, training_data_folder, qsm_challenge_2017_folder, qsm_challenge_2019_folder, shape, batch_size, get_train_data):
    ...
    # QSM challenges data
    datasets["qsm_2017"] = get_QSM_challenge_2017_data(base_path + qsm_challenge_2017_folder, (192, 192, 192), normalize=False)
    datasets["qsm_2019"] = get_QSM_challenge_2019_data(base_path + qsm_challenge_2019_folder, (192, 256, 256), normalize=True)
