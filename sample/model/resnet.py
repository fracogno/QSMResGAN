...
class ResBlockOLD(base_cnn.BaseCNN):
    def __init__(self, num_filters, kernel_size, stride, initializer, use_bias, upsampling, apply_batch_norm, dropout_rate):
        ...
        self.conv2 = self.CNN_layer_3D(num_filters, kernel_size, 1, initializer, use_bias, False, apply_batch_norm, dropout_rate, False)

        self.conv1b = self.CNN_layer_3D(num_filters, 1, stride, initializer, use_bias, upsampling, apply_batch_norm, dropout_rate, False)
